                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-48">
                          <DropdownMenuItem 
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              // TODO: Navigate to client's workspace dashboard
                              // This would be something like: router.push(`/workspace/${c.id}/dashboard`);
                              window.open(`/automations?client=${c.id}`, '_blank');
                            }}
                          >
                          ...
                          <DropdownMenuItem 
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              // TODO: Open email client or email modal
                              window.location.href = `mailto:contact@${c.name.toLowerCase().replace(/\s+/g, '')}.com?subject=WRK%20Copilot%20Inquiry`;
                            }}
                          >
