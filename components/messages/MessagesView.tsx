...
import { Send, Paperclip, MessageSquare, ShieldCheck, Search } from "lucide-react";
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex -space-x-2">
              <Avatar className="w-8 h-8 border-2 border-white">
                <AvatarFallback className="bg-gray-900 text-white text-xs">M</AvatarFallback>
              </Avatar>
              <Avatar className="w-8 h-8 border-2 border-white">
                  ...
                  >
                    <Avatar className="w-8 h-8 border border-gray-100 shrink-0 mt-1">
                      <AvatarFallback
                        className={cn(
                          "text-[10px] font-bold",
                          isMe ? "bg-gray-100 text-gray-600" : "bg-[#E43632] text-white"
                        )}
                      >
