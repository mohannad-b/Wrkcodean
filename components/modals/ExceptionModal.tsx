...
export function ExceptionModal({ isOpen, onClose, onAdd }: ExceptionModalProps) {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[480px] bg-white rounded-2xl shadow-2xl overflow-hidden p-8 z-50"
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                <h3 className="font-bold text-2xl text-[#0A0A0A] mb-1">Add an Exception</h3>
                <p className="text-gray-500 text-sm">
                  Define how the workflow should handle edge cases.
                </p>
              </div>
              <button
                onClick={onClose}
