...
export function SystemPickerModal({ isOpen, onClose, onSelect }: SystemPickerModalProps) {
          ...
          >
            ...
            <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-white z-10">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Select a platform to integrate with this workflow.
                </p>
              </div>
              <button
                onClick={onClose}
                className="text-gray-400 hover:text-[#0A0A0A] transition-colors bg-gray-50 hover:bg-gray-100 p-2 rounded-full"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="p-4 border-t border-gray-100 bg-white text-center">
              <p className="text-xs text-gray-400">
                Don&apos;t see your tool?{" "}
                <span className="text-[#E43632] font-bold cursor-pointer hover:underline">
