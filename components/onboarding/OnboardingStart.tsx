...
const TEMPLATES = [
  {
    ...
    icon: FileText,
    desc: "Extract data from PDFs & sync to Xero.",
  },
  {
    id: "onboarding",
    title: "Employee Onboarding",
    icon: Users,
    desc: "Provision accounts & send welcome emails.",
  },
  {
    id: "support",
    title: "Support Triage",
    icon: Headphones,
    desc: "Classify tickets & route to agents.",
  },
  { id: "leads", title: "Lead Routing", icon: Zap, desc: "Qualify leads & assign to sales reps." },
  {
    ...
    icon: Share2,
    desc: "Track brand mentions & auto-reply.",
  },
];

export function OnboardingStart({ onStart }: { onStart: () => void }) {
  return (
