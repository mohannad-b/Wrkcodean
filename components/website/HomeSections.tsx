    ...
    <section className="py-24 bg-white border-y border-gray-100">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-500">CoPilot turns your process into a workflow, then Wrk builds and runs it.</p>
        </div>
     ...
     <section className="py-24 bg-[#F9FAFB]">
       <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-12">
             <div>
                <h2 className="text-3xl font-bold text-[#0A0A0A] mb-2">Workflows for real-world operations.</h2>
                <p className="text-gray-500">Start with a template or build from scratch.</p>
             </div>
             <Button variant="outline" className="hidden md:flex rounded-full border-gray-300">Preview Workflow</Button>
          </div>
               ...
               <div key={i} className="bg-white rounded-2xl p-2 border border-gray-200 shadow-sm hover:shadow-md transition-all group cursor-pointer">
                  ...
                  <div className="bg-gray-900 rounded-xl aspect-video w-full mb-4 relative overflow-hidden border border-gray-100">
                     ...
                     <div className="absolute inset-0 bg-black/20 backdrop-blur-[1px] opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center z-20">
                        <span className="bg-white text-[#0A0A0A] px-4 py-2 rounded-full text-xs font-bold shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform">Preview Workflow</span>
                     </div>
                  </div>
     ...
     <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="text-3xl font-bold mb-1">$1,000 <span className="text-sm font-normal text-gray-500">/ setup</span></div>
              ...
              <div className="rounded-3xl p-8 border-2 border-[#0A0A0A] bg-[#0A0A0A] text-white relative shadow-xl transform md:-translate-y-4">
                 ...
                 <div className="text-3xl font-bold mb-1">$2,500 <span className="text-sm font-normal text-gray-400">/ setup</span></div>
     ...
     <section className="py-24 bg-white border-t border-gray-100">
        ...
        <div className="relative bg-[#0A0A0A] py-24 overflow-hidden">
           ...
           <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
              ...
              <p className="text-xl text-gray-400 mb-10">Start a workflow in under 2 minutes. No technical setup required.</p>
