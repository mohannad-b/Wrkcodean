      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
         ...
         <div className="mx-auto mb-16 max-w-4xl text-center">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-xl leading-relaxed text-gray-500 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
               WrkCoPilot turns plain-language processes into a detailed automation workflow. AI designs the system, Wrk engineers implement and monitor it, and you pay only for successfully completed tasks.
            </p>
