      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <h1 className="text-2xl font-bold text-[#0A0A0A]">{automationName}</h1>
            <Badge
              variant="outline"
              className="bg-emerald-50 text-emerald-700 border-emerald-200 rounded-full px-3 py-0.5 text-xs font-semibold tracking-wide uppercase"
            >
              {status}
            </Badge>
          </div>
          <p className="text-gray-500 max-w-2xl leading-relaxed text-sm">
            {automationDescription ||
              "Automates the reconciliation of incoming invoices against purchase orders in Xero. Triggers on email receipt, extracts data via AI, and creates draft bills for approval."}
          </p>
            ...
            <div className="p-5 space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-xs text-amber-800 leading-relaxed">
                  <span className="font-bold">Missing Credentials:</span> The Salesforce connector
                  needs re-authentication.
                </p>
              </div>
              <Button
                size="sm"
                className="w-full bg-white border border-amber-200 text-amber-700 hover:bg-amber-50 hover:text-amber-800 hover:border-amber-300 shadow-sm h-8 text-xs font-bold"
              >
                Fix Credentials
              </Button>
            </div>
