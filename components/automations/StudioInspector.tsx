        ...
        <div className="flex items-start justify-between mb-2">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Badge
                variant="outline"
                className={`capitalize rounded-md px-2 py-0.5 h-auto text-[10px] font-semibold tracking-wide ${
                  selectedStep.status === "complete"
                    ? "border-emerald-200 bg-emerald-50 text-emerald-700"
                    : selectedStep.status === "warning"
                      ? "border-amber-200 bg-amber-50 text-amber-700"
                      : selectedStep.status === "ai-suggested"
              ...
              <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 flex items-center gap-2">
                    ...
                    <Input
                      className="h-8 text-xs bg-gray-50 border-gray-200 font-medium w-20"
                      defaultValue="5000"
                    />
                  </div>
                </div>
            ...
            {selectedStep.exceptions && selectedStep.exceptions.length > 0 && (
              <div className="space-y-2 mb-3">
                {selectedStep.exceptions.map((ex, idx) => (
                  <div
                    key={idx}
                    className="bg-amber-50 border border-amber-100 rounded-lg p-3 text-xs flex items-start gap-2"
                  >
            ...
            <Collapsible open={isAdvancedOpen} onOpenChange={setIsAdvancedOpen}>
              <CollapsibleTrigger asChild>
                ...
                >
                  ...
                  <div
                    className={`p-1 rounded-full transition-all ${isAdvancedOpen ? "bg-gray-100 rotate-90" : "group-hover:bg-gray-50"}`}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-lg w-full">
                      ...
                      <Label htmlFor="notify-slack" className="text-xs font-medium">
                        Slack
                      </Label>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-lg w-full">
                    ...
                    <div className="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-lg w-full">
                      ...
                      <Label htmlFor="notify-sms" className="text-xs font-medium">
                        SMS
                      </Label>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-lg w-full">
                      <Switch id="notify-teams" className="data-[state=unchecked]:bg-gray-200" />
                      <Label htmlFor="notify-teams" className="text-xs font-medium">
                        MS Teams
                      </Label>
                    </div>
                  </div>
