...
interface ConditionEdgeData {
  ...
  onLabelChange?: (id: string, newLabel: string, newData: any) => void;
}
          ...
          {!isEditing ? (
            <div 
              ...
              className={cn(
                ...
                selected ? "border-[#E43632] ring-2 ring-[#E43632]/10" : "border-gray-200 hover:border-[#E43632]/50",
            ...
            >
               ...
               {data?.isMissingInfo && (
                 <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white px-2 py-1 rounded shadow-lg border border-gray-100 whitespace-nowrap flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                   ...
                   <span className="text-[10px] font-medium text-gray-600">AI Suggests: Add a threshold</span>
                 </div>
               )}
            </div>
          ) : (
