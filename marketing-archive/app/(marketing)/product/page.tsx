...
import { BuildStatusTab } from "@/components/BuildStatusTab";
...
const featurePillars = [
  {
    title: "CoPilot & Blueprinting",
    icon: MessageSquare,
    description:
      "Describe your process in plain language. WRK Copilot drafts the visual blueprint with logic, systems, and SLAs.",
  ...
  },
  {
    ...
    icon: GitBranch,
    description:
      "Our team implements your blueprint, connects systems, and runs test cycles until it is ready for production.",
...
export default function ProductPage() {
  const [activePreview, setActivePreview] = useState<"blueprint" | "build" | "activity">(
    "blueprint"
  );
      ...
      <section className="relative overflow-hidden bg-[#F9FAFB] px-6 pb-24 pt-32">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto max-w-3xl text-xl leading-relaxed text-gray-500">
            WRK Copilot combines an AI blueprint designer, a collaborative automation studio, and a
        ...
        <div className="mx-auto mt-16 max-w-6xl overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-2xl">
          <div className="flex flex-col gap-4 border-b border-gray-100 bg-gray-50/80 px-4 py-4 md:flex-row md:items-center md:gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {(["blueprint", "build", "activity"] as const).map((tab) => (
                <Button
                  key={tab}
