        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-[#0A0A0A] md:text-6xl">
              Start with a <span className="text-[#E43632]">Blueprint.</span> <br />
              Customize in seconds.
            </h1>
            <p className="mb-8 max-w-2xl text-xl leading-relaxed text-gray-500">
              Browse production-ready automation blueprints designed by experts. Launch with a template
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <div className="relative flex-1">
                ...
                <Input
                  placeholder="Search blueprints (e.g. 'Invoice', 'Slack')..."
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 text-center md:flex-row md:text-left">
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-gray-300">
              Tell Copilot what you want to automate. We&apos;ll draft the blueprint, wire the systems,
