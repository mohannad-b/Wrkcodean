...
export const CreateVersionModal: React.FC<CreateVersionModalProps> = ({ isOpen, onClose, onCreate, currentVersion }) => {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[450px] bg-white">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a draft based on <span className="font-bold text-gray-700">{currentVersion}</span> to safely make changes.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
           ...
           >
             {isLoading ? <Loader2 className="animate-spin mr-2" size={16} /> : <GitBranch className="mr-2" size={16} />}
             Create Version
           </Button>
        </DialogFooter>
      </DialogContent>
